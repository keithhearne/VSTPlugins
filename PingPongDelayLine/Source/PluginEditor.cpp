    ...
    : AudioProcessorEditor(ownerFilter)
{
    ...
    addAndMakeVisible (msecLabel = new Label ("msec Label",
                                              TRANS("msec\n")));
    msecLabel->setFont (Font (Font::getDefaultMonospacedFontName(), 13.00f, Font::bold));
    msecLabel->setJustificationType (Justification::centredLeft);
    msecLabel->setEditable (false, false, false);
    msecLabel->setColour (Label::textColourId, Colours::azure);
    msecLabel->setColour (TextEditor::textColourId, Colours::black);
    msecLabel->setColour (TextEditor::backgroundColourId, Colour (0x00ffffff));
...
void PingPongDelayAudioProcessorEditor::resized()
{
    ...
    HeaderName->setBounds (144, 24, 288, 24);
    msecLabel->setBounds (proportionOfWidth (0.2716f), proportionOfHeight (0.6655f), proportionOfWidth (0.1013f), proportionOfHeight (0.0811f));
    percentLabel->setBounds (proportionOfWidth (0.8513f), proportionOfHeight (0.6622f), proportionOfWidth (0.1013f), proportionOfHeight (0.0811f));
    //[UserResized] Add your own custom resize handling here..
    //[/UserResized]
}

void PingPongDelayAudioProcessorEditor::sliderValueChanged (Slider* sliderThatWasMoved)
{
    ...
    if (sliderThatWasMoved == MixKnob)
    {
        ...
        ourProcessor->setParameterNotifyingHost(PingPongDelayAudioProcessor::Mix, (float)MixKnob->getValue());
    ...
    else if (sliderThatWasMoved == FeedbackKnob)
    {
        ...
        ourProcessor->setParameterNotifyingHost(PingPongDelayAudioProcessor::Feedback, (float)FeedbackKnob->getValue());
    ...
    else if (sliderThatWasMoved == DelayKnob)
    {
        ...
        ourProcessor->setParameterNotifyingHost(PingPongDelayAudioProcessor::Delay, (float)DelayKnob->getValue());
...
void PingPongDelayAudioProcessorEditor::buttonClicked (Button* buttonThatWasClicked)
{
    ...
    if (buttonThatWasClicked == BypassButton)
    {
        ...
        ourProcessor->setParameterNotifyingHost(PingPongDelayAudioProcessor::MasterBypass, (float)BypassButton->getToggleState());
...
void PingPongDelayAudioProcessorEditor::visibilityChanged()
{
...
void PingPongDelayAudioProcessorEditor::timerCallback(){
    ...
    if(ourProcessor->NeedsUIUpdate()){
        BypassButton->setToggleState(1.0f == ourProcessor->getParameter(PingPongDelayAudioProcessor::MasterBypass), juce::dontSendNotification);
        MixKnob->setValue(ourProcessor->getParameter(PingPongDelayAudioProcessor::Mix), juce::dontSendNotification);
        DelayKnob->setValue(ourProcessor->getParameter(PingPongDelayAudioProcessor::Delay), juce::dontSendNotification);
        FeedbackKnob->setValue(ourProcessor->getParameter(PingPongDelayAudioProcessor::Feedback), juce::dontSendNotification);
...
<JUCER_COMPONENT documentType="Component" className="PingPongDelayAudioProcessorEditor"
                 componentName="" parentClasses="public AudioProcessorEditor, public Timer"
                 constructorParams="PingPongDelayAudioProcessor* ownerFilter"
  ...
  <LABEL name="Header" id="3f1695af01c1c947" memberName="HeaderName" virtualName=""
         explicitFocusOrder="0" pos="144 24 288 24" textCol="fff0f8ff"
         edTextCol="0" edBkgCol="0" labelText="Ping-Pong Delay" editableSingleClick="0"
         editableDoubleClick="0" focusDiscardsChanges="0" fontname="Default monospaced font"
         fontsize="22" bold="1" italic="1" justification="33"/>
  <LABEL name="msec Label" id="bf605abc5e3ae6ac" memberName="msecLabel"
         virtualName="" explicitFocusOrder="0" pos="27.155% 66.554% 10.129% 8.108%"
         textCol="fff0ffff" edTextCol="ff000000" edBkgCol="ffffff" labelText="msec&#10;"
         editableSingleClick="0" editableDoubleClick="0" focusDiscardsChanges="0"
         fontname="Default monospaced font" fontsize="13" bold="1" italic="0"
         justification="33"/>
  <LABEL name="percent Label" id="2c038db84cc2614" memberName="percentLabel"
         virtualName="" explicitFocusOrder="0" pos="85.129% 66.216% 10.129% 8.108%"
...
static const unsigned char resource_PingPongDelayAudioProcessorEditor_pluginbkg_png[] = { 137,80,78,71,13,10,26,10,0,0,0,13,73,72,68,82,0,0,1,208,0,0,1,40,8,6,0,0,0,232,156,160,116,0,0,0,6,98,75,71,68,
...
const char* PingPongDelayAudioProcessorEditor::pluginbkg_png = (const char*) resource_PingPongDelayAudioProcessorEditor_pluginbkg_png;
const int PingPongDelayAudioProcessorEditor::pluginbkg_pngSize = 36205;
