...
//==============================================================================
StereoDelayAudioProcessorEditor::StereoDelayAudioProcessorEditor (StereoDelayAudioProcessor* ownerFilter)
    : AudioProcessorEditor(ownerFilter)
{
    ...
    addAndMakeVisible (secLabel = new Label ("sec Label",
                                             TRANS("msecs")));
    secLabel->setFont (Font (Font::getDefaultMonospacedFontName(), 13.00f, Font::bold));
    ...
    addAndMakeVisible (DelayLabel2 = new Label ("Delay Label",
                                                TRANS("1931 Alan Blumlein patented binuraul stereo recording technique")));
    DelayLabel2->setFont (Font (Font::getDefaultMonospacedFontName(), 11.00f, Font::plain));
    DelayLabel2->setJustificationType (Justification::centred);
    DelayLabel2->setEditable (false, false, false);
    DelayLabel2->setColour (Label::textColourId, Colours::azure);
    DelayLabel2->setColour (TextEditor::textColourId, Colours::black);
    DelayLabel2->setColour (TextEditor::backgroundColourId, Colour (0x00ffffff));
...
void StereoDelayAudioProcessorEditor::resized()
{
    ...
    HeaderName->setBounds (169, 32, 150, 40);
    secLabel->setBounds (proportionOfWidth (0.2694f), proportionOfHeight (0.6655f), proportionOfWidth (0.1013f), proportionOfHeight (0.0811f));
    percentLabel->setBounds (proportionOfWidth (0.8535f), proportionOfHeight (0.6588f), proportionOfWidth (0.1013f), proportionOfHeight (0.0811f));
    DelayLabel2->setBounds (proportionOfWidth (0.0065f), proportionOfHeight (0.0101f), proportionOfWidth (0.6552f), proportionOfHeight (0.0811f));
...
void StereoDelayAudioProcessorEditor::sliderValueChanged (Slider* sliderThatWasMoved)
{
    ...
    StereoDelayAudioProcessor* ourProcessor = getProcessor();
    //[/UsersliderValueChanged_Pre]

    if (sliderThatWasMoved == MixKnob)
    {
        //[UserSliderCode_MixKnob] -- add your slider handling code here..
        ourProcessor->setParameterNotifyingHost(StereoDelayAudioProcessor::Mix, (float)MixKnob->getValue());
    ...
    else if (sliderThatWasMoved == FeedbackKnob)
    {
        ...
        ourProcessor->setParameterNotifyingHost(StereoDelayAudioProcessor::Feedback, (float)FeedbackKnob->getValue());
    ...
    else if (sliderThatWasMoved == DelayKnob)
    {
        ...
        ourProcessor->setParameterNotifyingHost(StereoDelayAudioProcessor::Delay, (float)DelayKnob->getValue());
...
void StereoDelayAudioProcessorEditor::buttonClicked (Button* buttonThatWasClicked)
{
    ...
    if (buttonThatWasClicked == BypassButton)
    {
        ...
        ourProcessor->setParameterNotifyingHost(StereoDelayAudioProcessor::MasterBypass, (float)BypassButton->getToggleState());
...
void StereoDelayAudioProcessorEditor::visibilityChanged()
{
...
void StereoDelayAudioProcessorEditor::timerCallback(){
    ...
    if(ourProcessor->NeedsUIUpdate()){
        BypassButton->setToggleState(1.0f == ourProcessor->getParameter(StereoDelayAudioProcessor::MasterBypass), juce::dontSendNotification);
        MixKnob->setValue(ourProcessor->getParameter(StereoDelayAudioProcessor::Mix), juce::dontSendNotification);
        DelayKnob->setValue(ourProcessor->getParameter(StereoDelayAudioProcessor::Delay), juce::dontSendNotification);
        FeedbackKnob->setValue(ourProcessor->getParameter(StereoDelayAudioProcessor::Feedback), juce::dontSendNotification);
...
<JUCER_COMPONENT documentType="Component" className="StereoDelayAudioProcessorEditor"
                 ...
                 constructorParams="StereoDelayAudioProcessor* ownerFilter" variableInitialisers="AudioProcessorEditor(ownerFilter)"
  ...
  <LABEL name="Header" id="3f1695af01c1c947" memberName="HeaderName" virtualName=""
         explicitFocusOrder="0" pos="169 32 150 40" textCol="fff0f8ff"
         edTextCol="0" edBkgCol="0" labelText="Stereo Delay&#10;AB1931&#10;"
         editableSingleClick="0" editableDoubleClick="0" focusDiscardsChanges="0"
         fontname="Default monospaced font" fontsize="22" bold="1" italic="1"
         justification="36"/>
  <LABEL name="sec Label" id="894d95782c69671c" memberName="secLabel"
         virtualName="" explicitFocusOrder="0" pos="26.94% 66.554% 10.129% 8.108%"
         textCol="fff0ffff" edTextCol="ff000000" edBkgCol="ffffff" labelText="msecs"
         editableSingleClick="0" editableDoubleClick="0" focusDiscardsChanges="0"
         fontname="Default monospaced font" fontsize="13" bold="1" italic="0"
         justification="33"/>
  <LABEL name="percent Label" id="7a2b53b83f8243d3" memberName="percentLabel"
         virtualName="" explicitFocusOrder="0" pos="85.345% 65.878% 10.129% 8.108%"
         textCol="fff0ffff" edTextCol="ff000000" edBkgCol="ffffff" labelText="%"
         editableSingleClick="0" editableDoubleClick="0" focusDiscardsChanges="0"
         fontname="Default monospaced font" fontsize="15" bold="1" italic="0"
         justification="33"/>
  <LABEL name="Delay Label" id="1c40ff33c625d188" memberName="DelayLabel2"
         virtualName="" explicitFocusOrder="0" pos="0.647% 1.014% 65.517% 8.108%"
         textCol="fff0ffff" edTextCol="ff000000" edBkgCol="ffffff" labelText="1931 Alan Blumlein patented binuraul stereo recording technique"
         editableSingleClick="0" editableDoubleClick="0" focusDiscardsChanges="0"
         fontname="Default monospaced font" fontsize="11" bold="0" italic="0"
         justification="36"/>
</JUCER_COMPONENT>
...
static const unsigned char resource_StereoDelayAudioProcessorEditor_pluginbkg_png[] = { 137,80,78,71,13,10,26,10,0,0,0,13,73,72,68,82,0,0,1,208,0,0,1,40,8,6,0,0,0,232,156,160,116,0,0,0,6,98,75,71,68,0,
255,0,255,0,255,160,189,167,147,0,0,0,9,112,72,89,115,0,0,11,19,0,0,11,19,1,0,154,156,24,0,0,0,7,116,73,77,69,7,222,9,11,20,47,2,217,204,96,98,0,0,0,29,105,84,88,116,67,111,109,109,101,110,116,0,0,0,0,
0,67,114,101,97,116,101,100,32,119,105,116,104,32,71,73,77,80,100,46,101,7,0,0,32,0,73,68,65,84,120,218,237,189,219,211,173,87,121,229,55,215,218,107,111,29,144,16,146,0,1,45,11,105,3,91,156,26,48,70,
...
const char* StereoDelayAudioProcessorEditor::pluginbkg_png = (const char*) resource_StereoDelayAudioProcessorEditor_pluginbkg_png;
const int StereoDelayAudioProcessorEditor::pluginbkg_pngSize = 36205;
