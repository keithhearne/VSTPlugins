...
//==============================================================================
BasicDelayAudioProcessorEditor::BasicDelayAudioProcessorEditor (BasicDelayAudioProcessor* ownerFilter)
    : AudioProcessorEditor(ownerFilter)
{
    ...
    addAndMakeVisible (DelayLabel2 = new Label ("msec Label",
                                                TRANS("msecs")));
    DelayLabel2->setFont (Font (Font::getDefaultMonospacedFontName(), 13.00f, Font::bold));
    ...
    addAndMakeVisible (DelayLabel3 = new Label ("Delay Label",
                                                TRANS("The Delta T-101 was the first digital delay circuit by Lexicon")));
    DelayLabel3->setFont (Font (Font::getDefaultMonospacedFontName(), 12.00f, Font::bold));
    DelayLabel3->setJustificationType (Justification::centred);
    DelayLabel3->setEditable (false, false, false);
    DelayLabel3->setColour (Label::textColourId, Colours::azure);
    DelayLabel3->setColour (TextEditor::textColourId, Colours::black);
    DelayLabel3->setColour (TextEditor::backgroundColourId, Colour (0x00ffffff));
...
void BasicDelayAudioProcessorEditor::resized()
{
    ...
    HeaderName->setBounds (128, 29, 216, 48);
    DelayLabel2->setBounds (proportionOfWidth (0.2694f), proportionOfHeight (0.6655f), proportionOfWidth (0.1013f), proportionOfHeight (0.0811f));
    ...
    DelayLabel3->setBounds (proportionOfWidth (0.0000f), proportionOfHeight (-0.0034f), proportionOfWidth (0.6207f), proportionOfHeight (0.0811f));
...
void BasicDelayAudioProcessorEditor::sliderValueChanged (Slider* sliderThatWasMoved)
{
    ...
    if (sliderThatWasMoved == MixKnob)
    {
        ...
        ourProcessor->setParameterNotifyingHost(BasicDelayAudioProcessor::Mix, (float)MixKnob->getValue());
    ...
    else if (sliderThatWasMoved == FeedbackKnob)
    {
        ...
        ourProcessor->setParameterNotifyingHost(BasicDelayAudioProcessor::Feedback, (float)FeedbackKnob->getValue());
    ...
    else if (sliderThatWasMoved == DelayKnob)
    {
        ...
        ourProcessor->setParameterNotifyingHost(BasicDelayAudioProcessor::Delay, (float)DelayKnob->getValue());
...
void BasicDelayAudioProcessorEditor::buttonClicked (Button* buttonThatWasClicked)
{
    ...
    if (buttonThatWasClicked == BypassButton)
    {
        ...
        ourProcessor->setParameterNotifyingHost(BasicDelayAudioProcessor::MasterBypass, (float)BypassButton->getToggleState());
...
void BasicDelayAudioProcessorEditor::visibilityChanged()
{
...
void BasicDelayAudioProcessorEditor::timerCallback(){
    ...
    if(ourProcessor->NeedsUIUpdate()){
        BypassButton->setToggleState(1.0f == ourProcessor->getParameter(BasicDelayAudioProcessor::MasterBypass), juce::dontSendNotification);
        MixKnob->setValue(ourProcessor->getParameter(BasicDelayAudioProcessor::Mix), juce::dontSendNotification);
        DelayKnob->setValue(ourProcessor->getParameter(BasicDelayAudioProcessor::Delay), juce::dontSendNotification);
        FeedbackKnob->setValue(ourProcessor->getParameter(BasicDelayAudioProcessor::Feedback), juce::dontSendNotification);
...
<JUCER_COMPONENT documentType="Component" className="BasicDelayAudioProcessorEditor"
                 ...
                 constructorParams="BasicDelayAudioProcessor* ownerFilter" variableInitialisers="AudioProcessorEditor(ownerFilter)"
  ...
  <SLIDER name="Delay Knob" id="3915f5df8ccf2427" memberName="DelayKnob"
          ...
          min="0" max="2000" int="1" style="Rotary" textBoxPos="TextBoxBelow"
          textBoxEditable="1" textBoxWidth="80" textBoxHeight="20" skewFactor="1"/>
  <LABEL name="Header" id="3f1695af01c1c947" memberName="HeaderName" virtualName=""
         explicitFocusOrder="0" pos="128 29 216 48" textCol="fff0f8ff"
         edTextCol="0" edBkgCol="0" labelText="Simple Mono Delay&#10;T-101"
         editableSingleClick="0" editableDoubleClick="0" focusDiscardsChanges="0"
         fontname="Default monospaced font" fontsize="22" bold="1" italic="1"
         justification="36"/>
  <LABEL name="msec Label" id="ebbb23e30fbab204" memberName="DelayLabel2"
         ...
         justification="36"/>
  <LABEL name="percent Label" id="e4b1872bffc38a76" memberName="percentLabel"
         ...
         justification="33"/>
  <LABEL name="Delay Label" id="9c2ab48d1656aa3" memberName="DelayLabel3"
         virtualName="" explicitFocusOrder="0" pos="0% -0.338% 62.069% 8.108%"
         textCol="fff0ffff" edTextCol="ff000000" edBkgCol="ffffff" labelText="The Delta T-101 was the first digital delay circuit by Lexicon"
         editableSingleClick="0" editableDoubleClick="0" focusDiscardsChanges="0"
...
static const unsigned char resource_BasicDelayAudioProcessorEditor_pluginbkg_png[] = { 137,80,78,71,13,10,26,10,0,0,0,13,73,72,68,82,0,0,1,208,0,0,1,40,8,6,0,0,0,232,156,160,116,0,0,0,6,98,75,71,68,0,
...
const char* BasicDelayAudioProcessorEditor::pluginbkg_png = (const char*) resource_BasicDelayAudioProcessorEditor_pluginbkg_png;
const int BasicDelayAudioProcessorEditor::pluginbkg_pngSize = 36205;
