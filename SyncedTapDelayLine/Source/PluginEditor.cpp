...
//==============================================================================
SyncedTapDelayAudioProcessorEditor::SyncedTapDelayAudioProcessorEditor (SyncedTapDelayAudioProcessor* ownerFilter)
    : AudioProcessorEditor(ownerFilter)
{
    addAndMakeVisible (T4groupComponent = new GroupComponent ("T4 group",
                                                              TRANS("Tap 4")));
    T4groupComponent->setColour (GroupComponent::outlineColourId, Colour (0x66ebe9e9));
    T4groupComponent->setColour (GroupComponent::textColourId, Colours::grey);

    addAndMakeVisible (T3groupComponent = new GroupComponent ("T3 group",
                                                              TRANS("Tap 3")));
    T3groupComponent->setColour (GroupComponent::outlineColourId, Colour (0x66ebe9e9));
    T3groupComponent->setColour (GroupComponent::textColourId, Colours::grey);

    addAndMakeVisible (T2groupComponent = new GroupComponent ("T2 group",
                                                              TRANS("Tap 2")));
    T2groupComponent->setColour (GroupComponent::outlineColourId, Colour (0x66ebe9e9));
    T2groupComponent->setColour (GroupComponent::textColourId, Colours::grey);

    addAndMakeVisible (T1groupComponent = new GroupComponent ("T1 group",
                                                              TRANS("Tap 1")));
    T1groupComponent->setColour (GroupComponent::outlineColourId, Colour (0x66ebe9e9));
    T1groupComponent->setColour (GroupComponent::textColourId, Colours::grey);
    ...
    addAndMakeVisible (Tap2Knob = new Slider ("Tap 2 Knob"));
    Tap2Knob->setTooltip (TRANS("Delay Tap 2"));
    Tap2Knob->setExplicitFocusOrder (1);
    Tap2Knob->setRange (0, 4, 1);
    Tap2Knob->setSliderStyle (Slider::Rotary);
    Tap2Knob->setTextBoxStyle (Slider::NoTextBox, false, 80, 20);
    Tap2Knob->setColour (Slider::backgroundColourId, Colours::cadetblue);
    Tap2Knob->setColour (Slider::trackColourId, Colours::coral);
    Tap2Knob->setColour (Slider::rotarySliderFillColourId, Colours::aquamarine);
    Tap2Knob->setColour (Slider::rotarySliderOutlineColourId, Colours::cadetblue);
    Tap2Knob->setColour (Slider::textBoxTextColourId, Colours::aliceblue);
    Tap2Knob->setColour (Slider::textBoxBackgroundColourId, Colours::cadetblue);
    Tap2Knob->setColour (Slider::textBoxHighlightColourId, Colours::coral);
    Tap2Knob->setColour (Slider::textBoxOutlineColourId, Colours::cadetblue);
    Tap2Knob->addListener (this);

    addAndMakeVisible (Tap3Knob = new Slider ("Tap 3 Knob"));
    Tap3Knob->setTooltip (TRANS("Delay Tap 3"));
    Tap3Knob->setExplicitFocusOrder (1);
    Tap3Knob->setRange (0, 4, 1);
    Tap3Knob->setSliderStyle (Slider::Rotary);
    Tap3Knob->setTextBoxStyle (Slider::NoTextBox, false, 80, 20);
    Tap3Knob->setColour (Slider::backgroundColourId, Colours::cadetblue);
    Tap3Knob->setColour (Slider::trackColourId, Colours::coral);
    Tap3Knob->setColour (Slider::rotarySliderFillColourId, Colours::aquamarine);
    Tap3Knob->setColour (Slider::rotarySliderOutlineColourId, Colours::cadetblue);
    Tap3Knob->setColour (Slider::textBoxTextColourId, Colours::aliceblue);
    Tap3Knob->setColour (Slider::textBoxBackgroundColourId, Colours::cadetblue);
    Tap3Knob->setColour (Slider::textBoxHighlightColourId, Colours::coral);
    Tap3Knob->setColour (Slider::textBoxOutlineColourId, Colours::cadetblue);
    Tap3Knob->addListener (this);

    addAndMakeVisible (Tap4Knob = new Slider ("Tap 4 Knob"));
    Tap4Knob->setTooltip (TRANS("Delay Tap 4"));
    Tap4Knob->setExplicitFocusOrder (1);
    Tap4Knob->setRange (0, 4, 1);
    Tap4Knob->setSliderStyle (Slider::Rotary);
    Tap4Knob->setTextBoxStyle (Slider::NoTextBox, false, 80, 20);
    Tap4Knob->setColour (Slider::backgroundColourId, Colours::cadetblue);
    Tap4Knob->setColour (Slider::trackColourId, Colours::coral);
    Tap4Knob->setColour (Slider::rotarySliderFillColourId, Colours::aquamarine);
    Tap4Knob->setColour (Slider::rotarySliderOutlineColourId, Colours::cadetblue);
    Tap4Knob->setColour (Slider::textBoxTextColourId, Colours::aliceblue);
    Tap4Knob->setColour (Slider::textBoxBackgroundColourId, Colours::cadetblue);
    Tap4Knob->setColour (Slider::textBoxHighlightColourId, Colours::coral);
    Tap4Knob->setColour (Slider::textBoxOutlineColourId, Colours::cadetblue);
    Tap4Knob->addListener (this);

    addAndMakeVisible (Tap2SyncLabel = new Label ("Tap 2 Sync Label",
                                                  TRANS("0")));
    Tap2SyncLabel->setFont (Font (15.00f, Font::plain));
    Tap2SyncLabel->setJustificationType (Justification::centred);
    Tap2SyncLabel->setEditable (false, false, false);
    Tap2SyncLabel->setColour (Label::backgroundColourId, Colours::cadetblue);
    Tap2SyncLabel->setColour (Label::textColourId, Colour (0xfff2eeee));
    Tap2SyncLabel->setColour (TextEditor::textColourId, Colours::black);
    Tap2SyncLabel->setColour (TextEditor::backgroundColourId, Colour (0x00000000));

    addAndMakeVisible (Tap3SyncLabel = new Label ("Tap 3 Sync Label",
                                                  TRANS("0")));
    Tap3SyncLabel->setFont (Font (15.00f, Font::plain));
    Tap3SyncLabel->setJustificationType (Justification::centred);
    Tap3SyncLabel->setEditable (false, false, false);
    Tap3SyncLabel->setColour (Label::backgroundColourId, Colours::cadetblue);
    Tap3SyncLabel->setColour (Label::textColourId, Colour (0xfff2eeee));
    Tap3SyncLabel->setColour (TextEditor::textColourId, Colours::black);
    Tap3SyncLabel->setColour (TextEditor::backgroundColourId, Colour (0x00000000));

    addAndMakeVisible (Tap4SyncLabel = new Label ("Tap 4 Sync Label",
                                                  TRANS("0")));
    Tap4SyncLabel->setFont (Font (15.00f, Font::plain));
    Tap4SyncLabel->setJustificationType (Justification::centred);
    Tap4SyncLabel->setEditable (false, false, false);
    Tap4SyncLabel->setColour (Label::backgroundColourId, Colours::cadetblue);
    Tap4SyncLabel->setColour (Label::textColourId, Colour (0xfff2eeee));
    Tap4SyncLabel->setColour (TextEditor::textColourId, Colours::black);
    Tap4SyncLabel->setColour (TextEditor::backgroundColourId, Colour (0x00000000));

    addAndMakeVisible (Delay2Label = new Label ("Delay 2 Label",
                                                TRANS("Delay")));
    Delay2Label->setFont (Font (Font::getDefaultMonospacedFontName(), 14.00f, Font::bold));
    Delay2Label->setJustificationType (Justification::centred);
    Delay2Label->setEditable (false, false, false);
    Delay2Label->setColour (Label::textColourId, Colours::azure);
    Delay2Label->setColour (TextEditor::textColourId, Colours::black);
    Delay2Label->setColour (TextEditor::backgroundColourId, Colour (0x00ffffff));

    addAndMakeVisible (Delay3Label = new Label ("Delay 3 Label",
                                                TRANS("Delay")));
    Delay3Label->setFont (Font (Font::getDefaultMonospacedFontName(), 14.00f, Font::bold));
    Delay3Label->setJustificationType (Justification::centred);
    Delay3Label->setEditable (false, false, false);
    Delay3Label->setColour (Label::textColourId, Colours::azure);
    Delay3Label->setColour (TextEditor::textColourId, Colours::black);
    Delay3Label->setColour (TextEditor::backgroundColourId, Colour (0x00ffffff));

    addAndMakeVisible (Delay4Label = new Label ("Delay 4 Label",
                                                TRANS("Delay")));
    Delay4Label->setFont (Font (Font::getDefaultMonospacedFontName(), 14.00f, Font::bold));
    Delay4Label->setJustificationType (Justification::centred);
    Delay4Label->setEditable (false, false, false);
    Delay4Label->setColour (Label::textColourId, Colours::azure);
    Delay4Label->setColour (TextEditor::textColourId, Colours::black);
    Delay4Label->setColour (TextEditor::backgroundColourId, Colour (0x00ffffff));
    ...
    addAndMakeVisible (Tap2LevelLabel4 = new Label ("Tap 2 Level Label",
                                                    TRANS("Level")));
    Tap2LevelLabel4->setFont (Font (Font::getDefaultMonospacedFontName(), 14.00f, Font::bold));
    Tap2LevelLabel4->setJustificationType (Justification::centred);
    Tap2LevelLabel4->setEditable (false, false, false);
    Tap2LevelLabel4->setColour (Label::textColourId, Colours::azure);
    Tap2LevelLabel4->setColour (TextEditor::textColourId, Colours::black);
    Tap2LevelLabel4->setColour (TextEditor::backgroundColourId, Colour (0x00ffffff));

    addAndMakeVisible (Tap2LevelKnob = new Slider ("Tap 2 Level Knob"));
    Tap2LevelKnob->setTooltip (TRANS("Tap 2 Gain"));
    Tap2LevelKnob->setExplicitFocusOrder (1);
    Tap2LevelKnob->setRange (0, 100, 1);
    Tap2LevelKnob->setSliderStyle (Slider::Rotary);
    Tap2LevelKnob->setTextBoxStyle (Slider::TextBoxBelow, false, 80, 20);
    Tap2LevelKnob->setColour (Slider::backgroundColourId, Colours::cadetblue);
    Tap2LevelKnob->setColour (Slider::trackColourId, Colours::coral);
    Tap2LevelKnob->setColour (Slider::rotarySliderFillColourId, Colours::aquamarine);
    Tap2LevelKnob->setColour (Slider::rotarySliderOutlineColourId, Colours::cadetblue);
    Tap2LevelKnob->setColour (Slider::textBoxTextColourId, Colours::aliceblue);
    Tap2LevelKnob->setColour (Slider::textBoxBackgroundColourId, Colours::cadetblue);
    Tap2LevelKnob->setColour (Slider::textBoxHighlightColourId, Colours::coral);
    Tap2LevelKnob->setColour (Slider::textBoxOutlineColourId, Colours::cadetblue);
    Tap2LevelKnob->addListener (this);

    addAndMakeVisible (Tap2LevelLabel3 = new Label ("Tap 2 Level Label",
                                                    TRANS("Level")));
    Tap2LevelLabel3->setFont (Font (Font::getDefaultMonospacedFontName(), 14.00f, Font::bold));
    Tap2LevelLabel3->setJustificationType (Justification::centred);
    Tap2LevelLabel3->setEditable (false, false, false);
    Tap2LevelLabel3->setColour (Label::textColourId, Colours::azure);
    Tap2LevelLabel3->setColour (TextEditor::textColourId, Colours::black);
    Tap2LevelLabel3->setColour (TextEditor::backgroundColourId, Colour (0x00ffffff));

    addAndMakeVisible (Tap3LevelKnob = new Slider ("Tap 3 Level Knob"));
    Tap3LevelKnob->setTooltip (TRANS("Tap 3 Gain"));
    Tap3LevelKnob->setExplicitFocusOrder (1);
    Tap3LevelKnob->setRange (0, 100, 1);
    Tap3LevelKnob->setSliderStyle (Slider::Rotary);
    Tap3LevelKnob->setTextBoxStyle (Slider::TextBoxBelow, false, 80, 20);
    Tap3LevelKnob->setColour (Slider::backgroundColourId, Colours::cadetblue);
    Tap3LevelKnob->setColour (Slider::trackColourId, Colours::coral);
    Tap3LevelKnob->setColour (Slider::rotarySliderFillColourId, Colours::aquamarine);
    Tap3LevelKnob->setColour (Slider::rotarySliderOutlineColourId, Colours::cadetblue);
    Tap3LevelKnob->setColour (Slider::textBoxTextColourId, Colours::aliceblue);
    Tap3LevelKnob->setColour (Slider::textBoxBackgroundColourId, Colours::cadetblue);
    Tap3LevelKnob->setColour (Slider::textBoxHighlightColourId, Colours::coral);
    Tap3LevelKnob->setColour (Slider::textBoxOutlineColourId, Colours::cadetblue);
    Tap3LevelKnob->addListener (this);

    addAndMakeVisible (Tap4LevelLabel3 = new Label ("Tap 4 Level Label",
                                                    TRANS("Level")));
    Tap4LevelLabel3->setFont (Font (Font::getDefaultMonospacedFontName(), 14.00f, Font::bold));
    Tap4LevelLabel3->setJustificationType (Justification::centred);
    Tap4LevelLabel3->setEditable (false, false, false);
    Tap4LevelLabel3->setColour (Label::textColourId, Colours::azure);
    Tap4LevelLabel3->setColour (TextEditor::textColourId, Colours::black);
    Tap4LevelLabel3->setColour (TextEditor::backgroundColourId, Colour (0x00ffffff));

    addAndMakeVisible (Tap4LevelKnob = new Slider ("Tap 4 Level Knob"));
    Tap4LevelKnob->setTooltip (TRANS("Tap 4 Gain"));
    Tap4LevelKnob->setExplicitFocusOrder (1);
    Tap4LevelKnob->setRange (0, 100, 1);
    Tap4LevelKnob->setSliderStyle (Slider::Rotary);
    Tap4LevelKnob->setTextBoxStyle (Slider::TextBoxBelow, false, 80, 20);
    Tap4LevelKnob->setColour (Slider::backgroundColourId, Colours::cadetblue);
    Tap4LevelKnob->setColour (Slider::trackColourId, Colours::coral);
    Tap4LevelKnob->setColour (Slider::rotarySliderFillColourId, Colours::aquamarine);
    Tap4LevelKnob->setColour (Slider::rotarySliderOutlineColourId, Colours::cadetblue);
    Tap4LevelKnob->setColour (Slider::textBoxTextColourId, Colours::aliceblue);
    Tap4LevelKnob->setColour (Slider::textBoxBackgroundColourId, Colours::cadetblue);
    Tap4LevelKnob->setColour (Slider::textBoxHighlightColourId, Colours::coral);
    Tap4LevelKnob->setColour (Slider::textBoxOutlineColourId, Colours::cadetblue);
    Tap4LevelKnob->addListener (this);
...
SyncedTapDelayAudioProcessorEditor::~SyncedTapDelayAudioProcessorEditor()
{
    //[Destructor_pre]. You can add your own custom destruction code here..
    //[/Destructor_pre]

    T4groupComponent = nullptr;
    T3groupComponent = nullptr;
    T2groupComponent = nullptr;
    ...
    Tap3Knob = nullptr;
    Tap4Knob = nullptr;
    Tap2SyncLabel = nullptr;
    Tap3SyncLabel = nullptr;
    Tap4SyncLabel = nullptr;
    Delay2Label = nullptr;
    Delay3Label = nullptr;
    Delay4Label = nullptr;
    Tap1LevelLabel3 = nullptr;
    Tap1LevelKnob = nullptr;
    Tap2LevelLabel4 = nullptr;
    Tap2LevelKnob = nullptr;
    Tap2LevelLabel3 = nullptr;
    Tap3LevelKnob = nullptr;
    Tap4LevelLabel3 = nullptr;
    Tap4LevelKnob = nullptr;
    DelayLabel = nullptr;
    DelayKnob = nullptr;
    secsLabel = nullptr;
...
//==============================================================================
void SyncedTapDelayAudioProcessorEditor::paint (Graphics& g)
{
...
void SyncedTapDelayAudioProcessorEditor::resized()
{
    T4groupComponent->setBounds (302, 157, 150, 110);
    T3groupComponent->setBounds (302, 43, 150, 110);
    T2groupComponent->setBounds (135, 156, 150, 110);
    T1groupComponent->setBounds (134, 42, 150, 110);
    Delay1Label->setBounds (proportionOfWidth (0.3233f), proportionOfHeight (0.1959f), proportionOfWidth (0.1013f), proportionOfHeight (0.0811f));
    MixLabel->setBounds (proportionOfWidth (0.0797f), proportionOfHeight (0.6824f), proportionOfWidth (0.1013f), proportionOfHeight (0.0811f));
    MixKnob->setBounds (proportionOfWidth (0.0711f), proportionOfHeight (0.7635f), proportionOfWidth (0.1207f), proportionOfHeight (0.1892f));
    BypassButton->setBounds (proportionOfWidth (0.7888f), proportionOfHeight (0.0169f), proportionOfWidth (0.1746f), proportionOfHeight (0.0811f));
    FeedbackLabel->setBounds (proportionOfWidth (0.0539f), proportionOfHeight (0.3277f), proportionOfWidth (0.1552f), proportionOfHeight (0.1655f));
    FeedbackKnob->setBounds (proportionOfWidth (0.0711f), proportionOfHeight (0.4527f), proportionOfWidth (0.1207f), proportionOfHeight (0.1892f));
    Tap1Knob->setBounds (proportionOfWidth (0.3319f), proportionOfHeight (0.2635f), proportionOfWidth (0.0862f), proportionOfHeight (0.1351f));
    HeaderName->setBounds (104, 8, 258, 36);
    Tap1SyncLabel->setBounds (154, 120, 40, 20);
    Tap2Knob->setBounds (proportionOfWidth (0.3319f), proportionOfHeight (0.6419f), proportionOfWidth (0.0862f), proportionOfHeight (0.1351f));
    Tap3Knob->setBounds (proportionOfWidth (0.6983f), proportionOfHeight (0.2669f), proportionOfWidth (0.0862f), proportionOfHeight (0.1351f));
    Tap4Knob->setBounds (proportionOfWidth (0.6983f), proportionOfHeight (0.6453f), proportionOfWidth (0.0862f), proportionOfHeight (0.1351f));
    Tap2SyncLabel->setBounds (154, 232, 40, 20);
    Tap3SyncLabel->setBounds (324, 120, 40, 20);
    Tap4SyncLabel->setBounds (324, 232, 40, 20);
    Delay2Label->setBounds (proportionOfWidth (0.3254f), proportionOfHeight (0.5777f), proportionOfWidth (0.1013f), proportionOfHeight (0.0811f));
    Delay3Label->setBounds (proportionOfWidth (0.7047f), proportionOfHeight (0.1959f), proportionOfWidth (0.1013f), proportionOfHeight (0.0811f));
    Delay4Label->setBounds (proportionOfWidth (0.6897f), proportionOfHeight (0.5743f), proportionOfWidth (0.1013f), proportionOfHeight (0.0811f));
    Tap1LevelLabel3->setBounds (proportionOfWidth (0.4720f), proportionOfHeight (0.1959f), proportionOfWidth (0.1013f), proportionOfHeight (0.0811f));
    Tap1LevelKnob->setBounds (proportionOfWidth (0.4806f), proportionOfHeight (0.2669f), proportionOfWidth (0.0862f), proportionOfHeight (0.2061f));
    Tap2LevelLabel4->setBounds (proportionOfWidth (0.4720f), proportionOfHeight (0.5777f), proportionOfWidth (0.1013f), proportionOfHeight (0.0811f));
    Tap2LevelKnob->setBounds (proportionOfWidth (0.4828f), proportionOfHeight (0.6453f), proportionOfWidth (0.0862f), proportionOfHeight (0.2061f));
    Tap2LevelLabel3->setBounds (proportionOfWidth (0.8362f), proportionOfHeight (0.1926f), proportionOfWidth (0.1013f), proportionOfHeight (0.0811f));
    Tap3LevelKnob->setBounds (proportionOfWidth (0.8448f), proportionOfHeight (0.2669f), proportionOfWidth (0.0862f), proportionOfHeight (0.2061f));
    Tap4LevelLabel3->setBounds (proportionOfWidth (0.8341f), proportionOfHeight (0.5743f), proportionOfWidth (0.1013f), proportionOfHeight (0.0811f));
    Tap4LevelKnob->setBounds (proportionOfWidth (0.8470f), proportionOfHeight (0.6453f), proportionOfWidth (0.0862f), proportionOfHeight (0.2061f));
    DelayLabel->setBounds (proportionOfWidth (0.0797f), proportionOfHeight (0.0405f), proportionOfWidth (0.1013f), proportionOfHeight (0.0811f));
    DelayKnob->setBounds (proportionOfWidth (0.0711f), proportionOfHeight (0.1216f), proportionOfWidth (0.1207f), proportionOfHeight (0.1892f));
    secsLabel->setBounds (proportionOfWidth (0.1853f), proportionOfHeight (0.2399f), proportionOfWidth (0.1013f), proportionOfHeight (0.0811f));
    percentLabel->setBounds (proportionOfWidth (0.1875f), proportionOfHeight (0.8818f), proportionOfWidth (0.1013f), proportionOfHeight (0.0811f));
    secsLabel2->setBounds (proportionOfWidth (0.2931f), proportionOfHeight (0.9189f), proportionOfWidth (0.5862f), proportionOfHeight (0.0811f));
    //[UserResized] Add your own custom resize handling here..
    //[/UserResized]
}

void SyncedTapDelayAudioProcessorEditor::sliderValueChanged (Slider* sliderThatWasMoved)
{
    //[UsersliderValueChanged_Pre]
    SyncedTapDelayAudioProcessor* ourProcessor = getProcessor();
    //[/UsersliderValueChanged_Pre]

    if (sliderThatWasMoved == MixKnob)
    {
        //[UserSliderCode_MixKnob] -- add your slider handling code here..
        ourProcessor->setParameterNotifyingHost(SyncedTapDelayAudioProcessor::Mix, (float)MixKnob->getValue());
    ...
    else if (sliderThatWasMoved == FeedbackKnob)
    {
        ...
        ourProcessor->setParameterNotifyingHost(SyncedTapDelayAudioProcessor::Feedback, (float)FeedbackKnob->getValue());
        //[/UserSliderCode_FeedbackKnob]
    }
    else if (sliderThatWasMoved == Tap1Knob)
    {
        //[UserSliderCode_Tap1Knob] -- add your slider handling code here..
        ourProcessor->setParameterNotifyingHost(SyncedTapDelayAudioProcessor::Tap1Delay, Tap1Knob->getValue());
        Tap1SyncLabel->setText(setSyncLabel(Tap1Knob->getValue()), juce::dontSendNotification);
        //[/UserSliderCode_Tap1Knob]
    }
    else if (sliderThatWasMoved == Tap2Knob)
    {
        //[UserSliderCode_Tap2Knob] -- add your slider handling code here..
        ourProcessor->setParameterNotifyingHost(SyncedTapDelayAudioProcessor::Tap2Delay, (float)Tap2Knob->getValue());
        Tap2SyncLabel->setText(setSyncLabel(Tap2Knob->getValue()), juce::dontSendNotification);
        //[/UserSliderCode_Tap2Knob]
    }
    else if (sliderThatWasMoved == Tap3Knob)
    {
        //[UserSliderCode_Tap3Knob] -- add your slider handling code here..
        ourProcessor->setParameterNotifyingHost(SyncedTapDelayAudioProcessor::Tap3Delay, (float)Tap3Knob->getValue());
        Tap3SyncLabel->setText(setSyncLabel(Tap3Knob->getValue()), juce::dontSendNotification);
        //[/UserSliderCode_Tap3Knob]
    }
    else if (sliderThatWasMoved == Tap4Knob)
    {
        //[UserSliderCode_Tap4Knob] -- add your slider handling code here..
        ourProcessor->setParameterNotifyingHost(SyncedTapDelayAudioProcessor::Tap4Delay, (float)Tap4Knob->getValue());
        Tap4SyncLabel->setText(setSyncLabel(Tap4Knob->getValue()), juce::dontSendNotification);
        //[/UserSliderCode_Tap4Knob]
    }
    else if (sliderThatWasMoved == Tap1LevelKnob)
    {
        //[UserSliderCode_Tap1LevelKnob] -- add your slider handling code here..
        ourProcessor->setParameterNotifyingHost(SyncedTapDelayAudioProcessor::Tap1Level, (float)Tap1LevelKnob->getValue()/100);
        //[/UserSliderCode_Tap1LevelKnob]
    }
    else if (sliderThatWasMoved == Tap2LevelKnob)
    {
        //[UserSliderCode_Tap2LevelKnob] -- add your slider handling code here..
        ourProcessor->setParameterNotifyingHost(SyncedTapDelayAudioProcessor::Tap2Level, (float)Tap2LevelKnob->getValue()/100);
        //[/UserSliderCode_Tap2LevelKnob]
    }
    else if (sliderThatWasMoved == Tap3LevelKnob)
    {
        //[UserSliderCode_Tap3LevelKnob] -- add your slider handling code here..
        ourProcessor->setParameterNotifyingHost(SyncedTapDelayAudioProcessor::Tap3Level, (float)Tap3LevelKnob->getValue()/100);
        //[/UserSliderCode_Tap3LevelKnob]
    }
    else if (sliderThatWasMoved == Tap4LevelKnob)
    {
        //[UserSliderCode_Tap4LevelKnob] -- add your slider handling code here..
        ourProcessor->setParameterNotifyingHost(SyncedTapDelayAudioProcessor::Tap4Level, (float)Tap4LevelKnob->getValue()/100);
        //[/UserSliderCode_Tap4LevelKnob]
    }
    else if (sliderThatWasMoved == DelayKnob)
    {
        //[UserSliderCode_DelayKnob] -- add your slider handling code here..
        ourProcessor->setParameterNotifyingHost(SyncedTapDelayAudioProcessor::Delay, (float)DelayKnob->getValue());
...
void SyncedTapDelayAudioProcessorEditor::buttonClicked (Button* buttonThatWasClicked)
{
    ...
    if (buttonThatWasClicked == BypassButton)
    {
        ...
        ourProcessor->setParameterNotifyingHost(SyncedTapDelayAudioProcessor::MasterBypass, (float)BypassButton->getToggleState());
...
void SyncedTapDelayAudioProcessorEditor::visibilityChanged()
{
...
void SyncedTapDelayAudioProcessorEditor::timerCallback(){
    SyncedTapDelayAudioProcessor* ourProcessor = getProcessor();
    //exchange any data you want between UI elements and the plugin "ourProcessor"
    if(ourProcessor->NeedsUIUpdate()){
        BypassButton->setToggleState(1.0f == ourProcessor->getParameter(SyncedTapDelayAudioProcessor::MasterBypass), juce::dontSendNotification);
        DelayKnob->setValue(ourProcessor->getParameter(SyncedTapDelayAudioProcessor::Delay), juce::dontSendNotification);
        FeedbackKnob->setValue(ourProcessor->getParameter(SyncedTapDelayAudioProcessor::Feedback), juce::dontSendNotification);
        MixKnob->setValue(ourProcessor->getParameter(SyncedTapDelayAudioProcessor::Mix), juce::dontSendNotification);
        Tap1Knob->setValue(ourProcessor->getParameter(SyncedTapDelayAudioProcessor::Tap1Delay), juce::dontSendNotification);
        Tap1LevelKnob->setValue(ourProcessor->getParameter(SyncedTapDelayAudioProcessor::Tap1Level), juce::dontSendNotification);
        Tap2Knob->setValue(ourProcessor->getParameter(SyncedTapDelayAudioProcessor::Tap2Delay), juce::dontSendNotification);
        Tap2LevelKnob->setValue(ourProcessor->getParameter(SyncedTapDelayAudioProcessor::Tap2Level), juce::dontSendNotification);
        Tap3Knob->setValue(ourProcessor->getParameter(SyncedTapDelayAudioProcessor::Tap3Delay), juce::dontSendNotification);
        Tap3LevelKnob->setValue(ourProcessor->getParameter(SyncedTapDelayAudioProcessor::Tap3Level), juce::dontSendNotification);
        Tap4Knob->setValue(ourProcessor->getParameter(SyncedTapDelayAudioProcessor::Tap4Delay), juce::dontSendNotification);
        Tap4LevelKnob->setValue(ourProcessor->getParameter(SyncedTapDelayAudioProcessor::Tap4Level), juce::dontSendNotification);
...
const String SyncedTapDelayAudioProcessorEditor::setSyncLabel(int sl){
    switch(sl){
        case 0:
            return "0";
        case 1:
...
<JUCER_COMPONENT documentType="Component" className="SyncedTapDelayAudioProcessorEditor"
                 componentName="" parentClasses="public AudioProcessorEditor, public Timer"
                 constructorParams="SyncedTapDelayAudioProcessor* ownerFilter"
  ...
  <GROUPCOMPONENT name="T4 group" id="d958636754ada231" memberName="T4groupComponent"
                  virtualName="" explicitFocusOrder="0" pos="302 157 150 110" outlinecol="66ebe9e9"
                  textcol="ff808080" title="Tap 4"/>
  <GROUPCOMPONENT name="T3 group" id="5aa2c5bf7dfe941c" memberName="T3groupComponent"
                  virtualName="" explicitFocusOrder="0" pos="302 43 150 110" outlinecol="66ebe9e9"
                  textcol="ff808080" title="Tap 3"/>
  <GROUPCOMPONENT name="T2 group" id="c7563a879ded915a" memberName="T2groupComponent"
                  virtualName="" explicitFocusOrder="0" pos="135 156 150 110" outlinecol="66ebe9e9"
                  textcol="ff808080" title="Tap 2"/>
  <GROUPCOMPONENT name="T1 group" id="6c9dd22d06b11348" memberName="T1groupComponent"
                  virtualName="" explicitFocusOrder="0" pos="134 42 150 110" outlinecol="66ebe9e9"
                  textcol="ff808080" title="Tap 1"/>
  <LABEL name="Delay 1 Label" id="a23f674e6696d274" memberName="Delay1Label"
         virtualName="" explicitFocusOrder="0" pos="32.328% 19.595% 10.129% 8.108%"
         textCol="fff0ffff" edTextCol="ff000000" edBkgCol="ffffff" labelText="Delay"
         editableSingleClick="0" editableDoubleClick="0" focusDiscardsChanges="0"
         fontname="Default monospaced font" fontsize="14" bold="1" italic="0"
         justification="36"/>
  <LABEL name="Mix Label" id="20f48f39f2927cb8" memberName="MixLabel"
         virtualName="" explicitFocusOrder="0" pos="7.974% 68.243% 10.129% 8.108%"
  ...
  <SLIDER name="Mix Knob" id="a6e532f29a4cf942" memberName="MixKnob" virtualName=""
          explicitFocusOrder="3" pos="7.112% 76.351% 12.069% 18.919%" bkgcol="ff5f9ea0"
          ...
          textboxoutline="ff5f9ea0" min="0" max="100" int="1" style="Rotary"
          textBoxPos="TextBoxBelow" textBoxEditable="1" textBoxWidth="80"
          textBoxHeight="20" skewFactor="1"/>
  <TEXTBUTTON name="Bypass Button" id="8aa6c522d03341a2" memberName="BypassButton"
              virtualName="" explicitFocusOrder="0" pos="78.879% 1.689% 17.457% 8.108%"
  ...
  <LABEL name="Feedback" id="da9addd18b45e924" memberName="FeedbackLabel"
         virtualName="" explicitFocusOrder="0" pos="5.388% 32.77% 15.517% 16.554%"
  ...
  <SLIDER name="Feedback Knob" id="5a515ddc99ab2af5" memberName="FeedbackKnob"
          virtualName="" explicitFocusOrder="2" pos="7.112% 45.27% 12.069% 18.919%"
  ...
  <SLIDER name="Tap 1 Knob" id="3915f5df8ccf2427" memberName="Tap1Knob"
          virtualName="" explicitFocusOrder="1" pos="33.19% 26.351% 8.621% 13.514%"
          tooltip="Delay Tap 1" bkgcol="ff5f9ea0" trackcol="ffff7f50" rotarysliderfill="ff7fffd4"
          rotaryslideroutline="ff5f9ea0" textboxtext="fff0f8ff" textboxbkgd="ff5f9ea0"
  ...
  <LABEL name="Header" id="3f1695af01c1c947" memberName="HeaderName" virtualName=""
         explicitFocusOrder="0" pos="104 8 258 36" textCol="fff0f8ff"
         edTextCol="0" edBkgCol="0" labelText="cSynced Tap Delay&#10;SE-201"
         editableSingleClick="0" editableDoubleClick="0" focusDiscardsChanges="0"
         fontname="Default monospaced font" fontsize="19.600000000000001421"
         bold="1" italic="1" justification="36"/>
  <LABEL name="Tap 1 Sync Label" id="b2883a5b4c3b3fcc" memberName="Tap1SyncLabel"
         virtualName="" explicitFocusOrder="0" pos="154 120 40 20" bkgCol="ff5f9ea0"
         textCol="fff2eeee" edTextCol="ff000000" edBkgCol="0" labelText="0"
         editableSingleClick="0" editableDoubleClick="0" focusDiscardsChanges="0"
         fontname="Default font" fontsize="15" bold="0" italic="0" justification="36"/>
  <SLIDER name="Tap 2 Knob" id="15f3ad1b745d12f3" memberName="Tap2Knob"
          virtualName="" explicitFocusOrder="1" pos="33.19% 64.189% 8.621% 13.514%"
          tooltip="Delay Tap 2" bkgcol="ff5f9ea0" trackcol="ffff7f50" rotarysliderfill="ff7fffd4"
          rotaryslideroutline="ff5f9ea0" textboxtext="fff0f8ff" textboxbkgd="ff5f9ea0"
          textboxhighlight="ffff7f50" textboxoutline="ff5f9ea0" min="0"
          max="4" int="1" style="Rotary" textBoxPos="NoTextBox" textBoxEditable="1"
          textBoxWidth="80" textBoxHeight="20" skewFactor="1"/>
  <SLIDER name="Tap 3 Knob" id="b6340244a16fc1df" memberName="Tap3Knob"
          virtualName="" explicitFocusOrder="1" pos="69.828% 26.689% 8.621% 13.514%"
          tooltip="Delay Tap 3" bkgcol="ff5f9ea0" trackcol="ffff7f50" rotarysliderfill="ff7fffd4"
          rotaryslideroutline="ff5f9ea0" textboxtext="fff0f8ff" textboxbkgd="ff5f9ea0"
          textboxhighlight="ffff7f50" textboxoutline="ff5f9ea0" min="0"
          max="4" int="1" style="Rotary" textBoxPos="NoTextBox" textBoxEditable="1"
          textBoxWidth="80" textBoxHeight="20" skewFactor="1"/>
  <SLIDER name="Tap 4 Knob" id="4d5dbe87bd1cc9e4" memberName="Tap4Knob"
          virtualName="" explicitFocusOrder="1" pos="69.828% 64.527% 8.621% 13.514%"
          tooltip="Delay Tap 4" bkgcol="ff5f9ea0" trackcol="ffff7f50" rotarysliderfill="ff7fffd4"
          rotaryslideroutline="ff5f9ea0" textboxtext="fff0f8ff" textboxbkgd="ff5f9ea0"
          textboxhighlight="ffff7f50" textboxoutline="ff5f9ea0" min="0"
          max="4" int="1" style="Rotary" textBoxPos="NoTextBox" textBoxEditable="1"
          textBoxWidth="80" textBoxHeight="20" skewFactor="1"/>
  <LABEL name="Tap 2 Sync Label" id="acdd94c732019810" memberName="Tap2SyncLabel"
         virtualName="" explicitFocusOrder="0" pos="154 232 40 20" bkgCol="ff5f9ea0"
         textCol="fff2eeee" edTextCol="ff000000" edBkgCol="0" labelText="0"
         editableSingleClick="0" editableDoubleClick="0" focusDiscardsChanges="0"
         fontname="Default font" fontsize="15" bold="0" italic="0" justification="36"/>
  <LABEL name="Tap 3 Sync Label" id="7413e076038d2b83" memberName="Tap3SyncLabel"
         virtualName="" explicitFocusOrder="0" pos="324 120 40 20" bkgCol="ff5f9ea0"
         textCol="fff2eeee" edTextCol="ff000000" edBkgCol="0" labelText="0"
         editableSingleClick="0" editableDoubleClick="0" focusDiscardsChanges="0"
         fontname="Default font" fontsize="15" bold="0" italic="0" justification="36"/>
  <LABEL name="Tap 4 Sync Label" id="334ef83700049d42" memberName="Tap4SyncLabel"
         virtualName="" explicitFocusOrder="0" pos="324 232 40 20" bkgCol="ff5f9ea0"
         textCol="fff2eeee" edTextCol="ff000000" edBkgCol="0" labelText="0"
         editableSingleClick="0" editableDoubleClick="0" focusDiscardsChanges="0"
         fontname="Default font" fontsize="15" bold="0" italic="0" justification="36"/>
  <LABEL name="Delay 2 Label" id="134586c4a5a7d14a" memberName="Delay2Label"
         virtualName="" explicitFocusOrder="0" pos="32.543% 57.77% 10.129% 8.108%"
         textCol="fff0ffff" edTextCol="ff000000" edBkgCol="ffffff" labelText="Delay"
         editableSingleClick="0" editableDoubleClick="0" focusDiscardsChanges="0"
         fontname="Default monospaced font" fontsize="14" bold="1" italic="0"
         justification="36"/>
  <LABEL name="Delay 3 Label" id="9e630e12b347a4e8" memberName="Delay3Label"
         virtualName="" explicitFocusOrder="0" pos="70.474% 19.595% 10.129% 8.108%"
         textCol="fff0ffff" edTextCol="ff000000" edBkgCol="ffffff" labelText="Delay"
         editableSingleClick="0" editableDoubleClick="0" focusDiscardsChanges="0"
         fontname="Default monospaced font" fontsize="14" bold="1" italic="0"
         justification="36"/>
  <LABEL name="Delay 4 Label" id="c9b6f8b27fe02e47" memberName="Delay4Label"
         virtualName="" explicitFocusOrder="0" pos="68.966% 57.432% 10.129% 8.108%"
         textCol="fff0ffff" edTextCol="ff000000" edBkgCol="ffffff" labelText="Delay"
         editableSingleClick="0" editableDoubleClick="0" focusDiscardsChanges="0"
         fontname="Default monospaced font" fontsize="14" bold="1" italic="0"
         justification="36"/>
  <LABEL name="Tap 1 Level Label" id="146cd4874dbe1b3a" memberName="Tap1LevelLabel3"
         virtualName="" explicitFocusOrder="0" pos="47.198% 19.595% 10.129% 8.108%"
         textCol="fff0ffff" edTextCol="ff000000" edBkgCol="ffffff" labelText="Level"
         editableSingleClick="0" editableDoubleClick="0" focusDiscardsChanges="0"
         fontname="Default monospaced font" fontsize="14" bold="1" italic="0"
         justification="36"/>
  <SLIDER name="Tap 1 Level Knob" id="a40042889663204b" memberName="Tap1LevelKnob"
          virtualName="" explicitFocusOrder="1" pos="48.06% 26.689% 8.621% 20.608%"
          tooltip="Tap 1 Gain" bkgcol="ff5f9ea0" trackcol="ffff7f50" rotarysliderfill="ff7fffd4"
          rotaryslideroutline="ff5f9ea0" textboxtext="fff0f8ff" textboxbkgd="ff5f9ea0"
          textboxhighlight="ffff7f50" textboxoutline="ff5f9ea0" min="0"
          max="100" int="1" style="Rotary" textBoxPos="TextBoxBelow" textBoxEditable="1"
          textBoxWidth="80" textBoxHeight="20" skewFactor="1"/>
  <LABEL name="Tap 2 Level Label" id="a28dea6e028294e0" memberName="Tap2LevelLabel4"
         virtualName="" explicitFocusOrder="0" pos="47.198% 57.77% 10.129% 8.108%"
         textCol="fff0ffff" edTextCol="ff000000" edBkgCol="ffffff" labelText="Level"
         editableSingleClick="0" editableDoubleClick="0" focusDiscardsChanges="0"
         fontname="Default monospaced font" fontsize="14" bold="1" italic="0"
         justification="36"/>
  <SLIDER name="Tap 2 Level Knob" id="68ca3484446b8b63" memberName="Tap2LevelKnob"
          virtualName="" explicitFocusOrder="1" pos="48.276% 64.527% 8.621% 20.608%"
          tooltip="Tap 2 Gain" bkgcol="ff5f9ea0" trackcol="ffff7f50" rotarysliderfill="ff7fffd4"
          rotaryslideroutline="ff5f9ea0" textboxtext="fff0f8ff" textboxbkgd="ff5f9ea0"
          textboxhighlight="ffff7f50" textboxoutline="ff5f9ea0" min="0"
          max="100" int="1" style="Rotary" textBoxPos="TextBoxBelow" textBoxEditable="1"
          textBoxWidth="80" textBoxHeight="20" skewFactor="1"/>
  <LABEL name="Tap 2 Level Label" id="151e5b2a754427b2" memberName="Tap2LevelLabel3"
         virtualName="" explicitFocusOrder="0" pos="83.621% 19.257% 10.129% 8.108%"
         textCol="fff0ffff" edTextCol="ff000000" edBkgCol="ffffff" labelText="Level"
         editableSingleClick="0" editableDoubleClick="0" focusDiscardsChanges="0"
         fontname="Default monospaced font" fontsize="14" bold="1" italic="0"
         justification="36"/>
  <SLIDER name="Tap 3 Level Knob" id="b15f12be1ad1e69b" memberName="Tap3LevelKnob"
          virtualName="" explicitFocusOrder="1" pos="84.483% 26.689% 8.621% 20.608%"
          tooltip="Tap 3 Gain" bkgcol="ff5f9ea0" trackcol="ffff7f50" rotarysliderfill="ff7fffd4"
          rotaryslideroutline="ff5f9ea0" textboxtext="fff0f8ff" textboxbkgd="ff5f9ea0"
          textboxhighlight="ffff7f50" textboxoutline="ff5f9ea0" min="0"
          max="100" int="1" style="Rotary" textBoxPos="TextBoxBelow" textBoxEditable="1"
          textBoxWidth="80" textBoxHeight="20" skewFactor="1"/>
  <LABEL name="Tap 4 Level Label" id="ea7214930559abe3" memberName="Tap4LevelLabel3"
         virtualName="" explicitFocusOrder="0" pos="83.405% 57.432% 10.129% 8.108%"
         textCol="fff0ffff" edTextCol="ff000000" edBkgCol="ffffff" labelText="Level"
         editableSingleClick="0" editableDoubleClick="0" focusDiscardsChanges="0"
         fontname="Default monospaced font" fontsize="14" bold="1" italic="0"
         justification="36"/>
  <SLIDER name="Tap 4 Level Knob" id="7161e6874422d8f8" memberName="Tap4LevelKnob"
          virtualName="" explicitFocusOrder="1" pos="84.698% 64.527% 8.621% 20.608%"
          tooltip="Tap 4 Gain" bkgcol="ff5f9ea0" trackcol="ffff7f50" rotarysliderfill="ff7fffd4"
          rotaryslideroutline="ff5f9ea0" textboxtext="fff0f8ff" textboxbkgd="ff5f9ea0"
          textboxhighlight="ffff7f50" textboxoutline="ff5f9ea0" min="0"
          max="100" int="1" style="Rotary" textBoxPos="TextBoxBelow" textBoxEditable="1"
          textBoxWidth="80" textBoxHeight="20" skewFactor="1"/>
  <LABEL name="Delay Label" id="d0b87526eb1cd150" memberName="DelayLabel"
         virtualName="" explicitFocusOrder="0" pos="7.974% 4.054% 10.129% 8.108%"
         tooltip="Delay" textCol="fff0ffff" edTextCol="ff000000" edBkgCol="ffffff"
         labelText="Delay" editableSingleClick="0" editableDoubleClick="0"
         focusDiscardsChanges="0" fontname="Default monospaced font" fontsize="16"
         bold="1" italic="0" justification="36"/>
  <SLIDER name="Delay Knob" id="2d76b7c0ae36c97b" memberName="DelayKnob"
          virtualName="" explicitFocusOrder="3" pos="7.112% 12.162% 12.069% 18.919%"
          bkgcol="ff5f9ea0" trackcol="ffff7f50" rotarysliderfill="ff7fffd4"
          rotaryslideroutline="ff5f9ea0" textboxtext="fff0f8ff" textboxbkgd="ff5f9ea0"
          textboxhighlight="ffff7f50" textboxoutline="ff5f9ea0" min="0"
          max="2" int="0.010000000000000000208" style="Rotary" textBoxPos="TextBoxBelow"
          textBoxEditable="1" textBoxWidth="80" textBoxHeight="20" skewFactor="1"/>
  <LABEL name="secs Label" id="57b4c0c57083c47" memberName="secsLabel"
         virtualName="" explicitFocusOrder="0" pos="18.534% 23.986% 10.129% 8.108%"
         tooltip="Delay" textCol="fff0ffff" edTextCol="ff000000" edBkgCol="ffffff"
         labelText="secs" editableSingleClick="0" editableDoubleClick="0"
         focusDiscardsChanges="0" fontname="Default monospaced font" fontsize="13"
         bold="1" italic="0" justification="33"/>
  <LABEL name="percent Label" id="eac04e09f99a1088" memberName="percentLabel"
         virtualName="" explicitFocusOrder="0" pos="18.75% 88.176% 10.129% 8.108%"
         tooltip="Delay" textCol="fff0ffff" edTextCol="ff000000" edBkgCol="ffffff"
         labelText="%" editableSingleClick="0" editableDoubleClick="0"
         focusDiscardsChanges="0" fontname="Default monospaced font" fontsize="15"
         bold="1" italic="0" justification="33"/>
  <LABEL name="secs Label" id="7eeddf40b17aa7b0" memberName="secsLabel2"
         virtualName="" explicitFocusOrder="0" pos="29.31% 91.892% 58.621% 8.108%"
         tooltip="Delay" textCol="fff0ffff" edTextCol="ff000000" edBkgCol="ffffff"
         labelText="RE-201 Roland Space Echo one of the first tap delays"
         editableSingleClick="0" editableDoubleClick="0" focusDiscardsChanges="0"
         fontname="Default monospaced font" fontsize="13" bold="1" italic="0"
         justification="33"/>
</JUCER_COMPONENT>
...
static const unsigned char resource_SyncedTapDelayAudioProcessorEditor_pluginbkg_png[] = { 137,80,78,71,13,10,26,10,0,0,0,13,73,72,68,82,0,0,1,208,0,0,1,40,8,6,0,0,0,232,156,160,116,0,0,0,6,98,75,71,68,
...
const char* SyncedTapDelayAudioProcessorEditor::pluginbkg_png = (const char*) resource_SyncedTapDelayAudioProcessorEditor_pluginbkg_png;
const int SyncedTapDelayAudioProcessorEditor::pluginbkg_pngSize = 36205;
