...
//-------------------------------------------------------------------------
float Moorer::getEROutput(const float in){
...
// used to get individual outputs for summing in stereo
//-------------------------------------------------------------------------
float Moorer::getCombOutput(float in, int id){
...
// used to get individual outputs for summing in stereo
//-------------------------------------------------------------------------
float Moorer::getAllpassOutput(float in, int id){
