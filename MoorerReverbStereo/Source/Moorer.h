...
public:
    ...
    Moorer(const int sr = 44100, const float rt60 = 3.0,
              const float cDelay1 = 50.0, const float cDelay2 = 56.0, const float cDelay3 = 61.0, const float cDelay4 = 68.0,
              const float cDelay5 = 72.0, const float cDelay6 = 78.0,
              const float aDelay1 = 6.0, const float aGain1 = 0.707,
              const float lCutoff1 = 4942.0f, const float lCutoff2 = 4363.0f, const float lCutoff3 = 4312.0f,
              const float lCutoff4 = 4574.0f, const float lCutoff5 = 3981.0f, const float lCutoff6 = 4036.0f, float ld = 10.0f);
    ~Moorer();
    ...
    private:
    float decayFactor, ALLPASS_GAIN_LIMIT = 0.707f, lp_freq, lateDelay; // GAIN LIMIT to keep the allpasses from exploding
    bool bypass;
